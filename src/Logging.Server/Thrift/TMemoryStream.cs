...
namespace Thrift
{
    ...
    /// </summary>
    //public class TMemoryStream : Stream       /* http://msdn.microsoft.com/en-us/library/system.io.stream.aspx */
    //{
    //    #region Constructors
    ...
    //    public TMemoryStream(byte[] source)
    //    {
    ...
    //    public TMemoryStream(int length)
    //    {
    //        SetLength(length);
    //        Position = length;
    ...
    //    #endregion Public Stream Methods
    ...
    //    #endregion Public Additional Helper Methods
    //}
